...
Output ONLY valid JSON, no markdown, no preamble, exactly this shape:
{
  ...
  "walkAway": "the SMART maximum a BUYER should pay to still profit or get a genuine deal — favorable to the buyer but realistic enough to actually win the item. Set it in the LOWER-MIDDLE of the value range (roughly value low end up to the low-mid point), NOT rock-bottom. For resale-minded buyers it protects margin; for collectors it's still a fair price that wins the item. Never an insulting lowball that would lose the deal.",
  "scenarios": [
